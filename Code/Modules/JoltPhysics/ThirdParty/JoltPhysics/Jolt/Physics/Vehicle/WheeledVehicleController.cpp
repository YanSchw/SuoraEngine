...
void WheeledVehicleController::Draw(DebugRenderer *inRenderer) const
{
	...
	JoltString status = JoltStringFormat("Forward: %.1f, Right: %.1f\nBrake: %.1f, HandBrake: %.1f\n"
